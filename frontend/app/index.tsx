...
const THEMES = {
  cream: {
    ...
    cardBg: "#ffffff",
    cardBorder: "#dfe6f0",
    expiredCardBg: "#ffe9ea",
    keyBg: "#e7efff",
    expiredKeyBg: "#ffe2e4",
    accent: "#2459e0",
    accentLight: "rgba(36,89,224,0.12)",
    textPrimary: "#1a2436",
  ...
  gold: {
    ...
    cardBg: "#1f2430",
    cardBorder: "#2c3440",
    expiredCardBg: "#3a1f24",
    keyBg: "rgba(245,183,0,0.18)",
    expiredKeyBg: "rgba(239,68,68,0.28)",
    accent: "#f5b700",
    accentLight: "rgba(245,183,0,0.25)",
    textPrimary: "#f8f5ef",
  ...
  cyber: {
    ...
    cardBg: "#17213a",
    cardBorder: "#23324c",
    expiredCardBg: "#3b1f2a",
    keyBg: "rgba(51,212,255,0.2)",
    expiredKeyBg: "rgba(239,68,68,0.25)",
    accent: "#33d4ff",
    accentLight: "rgba(51,212,255,0.18)",
    textPrimary: "#e7f7ff",
    textSecondary: "#9fd8ff",
    border: "#23324c",
    success: "#1dd2a3",
    danger: "#ff5c5c",
    header: "#2188ff",
  ...
  firebase: {
    ...
    bgCard: "#3a2215",
    cardBg: "#3a2215",
    cardBorder: "rgba(255,138,61,0.45)",
    expiredCardBg: "#4b2020",
    keyBg: "rgba(255,138,61,0.25)",
    expiredKeyBg: "rgba(255,82,82,0.25)",
    accent: "#ff8a3d",
    accentLight: "rgba(255,138,61,0.28)",
    textPrimary: "#fff3e6",
    textSecondary: "#ffd5b5",
    border: "#ff8a3d",
    success: "#ffb703",
    danger: "#ff5a5f",
    header: "#ff8a3d",
