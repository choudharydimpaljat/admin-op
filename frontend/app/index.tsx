...
const THEMES = {
  ...
  gold: {
    ...
    cardBg: "#2a2a2a",
    cardBorder: "#3a3a3a",
    expiredCardBg: "#4a1c1c",
    keyBg: "rgba(255,193,7,0.15)",
  ...
  cyber: {
    ...
    cardBg: "#0f1627",
    cardBorder: "#1f2c44",
    expiredCardBg: "#3a1f28",
    keyBg: "rgba(0,245,255,0.2)",
    expiredKeyBg: "rgba(239,68,68,0.25)",
    accent: "#00f5ff",
  ...
  firebase: {
    ...
    bgCard: "#4A3520",
    cardBg: "#4A3520",
    cardBorder: "rgba(255,152,0,0.4)",
    expiredCardBg: "#5C2020",
    keyBg: "rgba(255,152,0,0.25)",
